# Fetch the OpenStreetMap basemap that content/en/gis.qmd shows, once, and save it.
...
# content/en/gis.qmd shows PNG images made from this file on 2026-09-02. They are
