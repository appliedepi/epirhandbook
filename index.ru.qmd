...
**Задача:** Служит кратким справочником по R (онлайн и [**оффлайн**](chapters/data_used.ru.qmd)) с примерами, ориентированными на задачи, которые направлены на часто встречающиеся проблемы в эпидемиологии.  
...
* Вы можете работать параллельно с помощью [примера данных](chapters/data_used.ru.qmd)  

**Оффлайн версия**  

См. инструкции на странице [Скачивание руководства и данных](chapters/data_used.ru.qmd).  
