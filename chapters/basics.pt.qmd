...
- Especifique as duas cores a serem utilizadas (`pal =` é a abreviação de "paleta" e é fornecido com um vetor de dois nomes de cores. Veja a página [objetos](basics.pt.qmd#objects) para saber como a função `c()` faz um vetor)
