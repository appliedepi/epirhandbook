---
aliases:
  - /new_pages/interactive_plots.fr.html
---
...
Pour commencer, nous allons importer une base de données appelée linelist_cleaned contenant les cas d'une épidémie d'Ebola simulée. Chargez-les directement avec `appliedepidata::get_data(name = "linelist_cleaned_rds")` (voir la page [Télécharger le manuel et les données](data_used.fr.qmd) pour plus de détails).  
...
* Ajustements portant sur l'affichage ou non des données lorsque vous ne survolez pas la ligne.
