...
Bộ dữ liệu minh họa được sử dụng trong phần này là số lượng các trường hợp campylobacter hàng tuần được báo cáo ở Đức từ năm 2001 đến 2011. Tải trực tiếp bằng `appliedepidata::get_data(name = "campylobacter_germany")` (xem trang [Tải sách và dữ liệu](data_used.vn.qmd) để biết chi tiết).  
