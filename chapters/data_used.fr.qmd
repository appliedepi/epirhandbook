...
* Pour télécharger le fichier de l'arbre phylogénétique "Shigella_tree.txt", cliquez avec le bouton droit de la souris sur ce ```{r, eval=F}
tree <- appliedepidata::get_data(name = "Shigella_tree")
``` (Cmd+click for Mac) et sélectionnez "Enregistrer le lien sous". 
* Pour télécharger le fichier "sample_data_Shigella_tree.csv" contenant des informations supplémentaires sur chaque échantillon, cliquez avec le bouton droit de la souris sur ce ```{r, eval=F}
sample_data <- appliedepidata::get_data(name = "sample_data_Shigella_tree")
``` (Cmd+clic pour Mac) et sélectionnez "Enregistrer le lien sous".  
* Pour voir le nouveau sous-arbre créé, cliquez avec le bouton droit de la souris sur ce ```{r, eval=F}
subtree <- appliedepidata::get_data(name = "Shigella_subtree_2")
``` (Cmd+clic pour Mac) et sélectionnez "Enregistrer le lien sous". Le fichier .txt sera téléchargé sur votre ordinateur.  
