...
Pour la page sur la [standardisation des données](standardization.fr.qmd), vous pouvez charger les données directement depuis notre dépôt Github sur internet dans votre session R avec les commandes suivantes :  
