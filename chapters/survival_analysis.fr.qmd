---
aliases:
  - /new_pages/survival_analysis.fr.html
---
...
<span style="color : black ;">**_NOTE:_** Un deuxième argument appelé *méthode* peut être spécifié lors du calcul du modèle de cox, qui détermine comment les ex aequo sont traités. Le *défaut* est "efron", et les autres options sont "breslow" et "exact".</span>
