...
Simüle edilmiş bir Ebola salgını veri setini içe aktarıyoruz. Doğrudan `appliedepidata::get_data(name = "linelist_cleaned_rds")` ile yükleyin (ayrıntılar için [El kitabı ve veri indirme](data_used.tr.qmd) sayfasına bakın).
...
Ayrıca istatistiksel testlerin sonuçlarını gtsummary tablolarına ekleyebilirsiniz. Bu işlem, Basit istatistik testleri sayfasının gtsummary bölümünde açıklanmıştır.[Basit istatistiksel testler](stat_tests.tr.qmd#stats_gt) sayfası.
...
• Denklemin sağ tarafı, **stringr**'den `str_glue()` sözdizimini kullanır (bkz. [Karakterler ve dizeler](characters_strings.tr.qmd)); istenen görüntüleme dizesi tırnak içinde, istatistiklerin kendisi ise küme parantezleri içinde yazılır. “n” (sayılar için), “N” (payda için), “mean”, “median”, “sd”, “max”, “min”, yüzdelikleri ( “p##” olarak; örneğin p25, toplamın yüzdeliği p) dahil edebilirsiniz. Ayrıntılar için ?tbl_summary komutunu uygulayın.
