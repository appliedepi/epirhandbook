...
Chúng tôi khuyến khích bạn sử dụng thư mục "scripts" để lưu trữ "runfiles" hoặc các .R scripts được dẫn nguồn từ các .Rmd scripts của bạn. Xem trang trên [R Markdown](rmarkdown.vn.qmd) để biết các mẹo về cách cấu trúc code của bạn trên một số tệp.  
