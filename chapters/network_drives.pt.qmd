---
aliases:
  - /new_pages/network_drives.pt.html
---
...
-   Verifique a instalação de TinyTex, ou instale TinyTex em C:. Veja na página [Introdução ao R](basics.pt.qmd) sobre como instalar o TinyTex. 
...
**A biblioteca C: não aparece como opção quando tento instalar pacotes manualmente**
...
-   Em seguida, no gerenciador de arquivos do Windows, você precisará clicar com o botão direito do mouse em "Este Computador" no painel à direita, e selecionar "Mapear uma unidade de rede".\
