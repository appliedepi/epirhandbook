...
Voir la page [Télécharger le manuel et les données](#download_book_data) pour savoir comment télécharger tous les exemples de données du manuel. Vous pouvez charger les données de la page de normalisation directement dans R avec les appels `appliedepidata::get_data()` suivants :  
