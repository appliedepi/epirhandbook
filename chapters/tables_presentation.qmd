---
aliases:
  - /new_pages/tables_presentation.html
---
...
Instead, we can specify widths with the `width()` function. It can take some playing around to know what width value to put. In the example below, we specify different widths for column 1, column 2, and columns 4, 5, 7, and 8.
