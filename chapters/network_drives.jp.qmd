---
aliases:
  - /new_pages/network_drives.jp.html
---
...
* RStudio の Tools/Global Options から 32-bit 版の R を選択してみてください。
  * 注意：32-bit 版の R がメニューに表示されない場合は、お使いの RStudio のバージョンが古い（v1.2）場合があります。
...
* 次に、Windows のエクスプローラーを開き、右パネルにある「PC」を右クリックし、「ネットワークドライブの割当」を選択します。
