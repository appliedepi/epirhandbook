...
Để chuyển đổi các số có một chữ số thành hai chữ số (ví dụ: để “độn thêm” giờ hoặc phút với các số 0 ở đầu để đạt được 2 chữ số), hãy xem phần ["Độ dài chuỗi ký tự" trong chương Ký tự và chuỗi](characters_strings.vn.qmd#str_pad).  
