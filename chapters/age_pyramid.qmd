...
Import and view the population data (see [Download handbook and data](data_used.qmd) page):
...
Import the data (see [Download handbook and data](data_used.qmd) page if desired).  
