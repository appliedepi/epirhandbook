...
Voici un exemple tiré de la page [Tables descriptives](#descriptive_tables) sur la conversion de la "liste linéaire des cas" en un tableau de données qui résume/synthétise l'issue finale des patients et les valeurs CT par hôpital, avec une ligne de totaux en bas. Le résultat est enregistré sous le nom de `table`.
