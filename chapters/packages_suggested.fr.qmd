...
* Le paquet **appliedepidata** contient toutes les données d'exemple pour ce manuel. Voir [Télécharger le manuel et les données](data_used.qmd) pour la version hors ligne du manuel.  
