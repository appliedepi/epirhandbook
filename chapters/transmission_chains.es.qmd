---
aliases:
  - /new_pages/transmission_chains.es.html
---
...
Importamos el conjunto de datos de casos de una epidemia de ébola simulada. Si deseas descargar los datos para seguirlos paso a paso, consulta las instrucciones en la página de [descargando el manual y los datos](data_used.es.qmd). El conjunto de datos se importa utilizando la función `import()` del paquete **rio**. Consulta la página sobre [importación y exportación](importing.es.qmd) para conocer las distintas formas de importar datos.
...
¿Qué diez personas son las que tienen más contactos?
