---
aliases:
  - /new_pages/packages_suggested.html
---
...
* The **appliedepidata** package contains all the example data for this handbook. See [Download handbook and data](data_used.qmd) for the offline version of the handbook.  
...
# The data package for this handbook, which includes all the example data
