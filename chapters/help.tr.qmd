...
Çalışmanızı Github'da nasıl saklayacağınızla ilgili daha fazla bilgiyi [İşbirliği ve Github](collaboration.tr.qmd) sayfasından okuyabilirsiniz.
...
1) **reprex**, **tidyverse** ile kurulur, bu nedenle paketlerden herhangi birini yükleyin
...
* 'session_info = TRUE' olarak ayarlarsanız, R sürümünüzü ve R paket sürümlerinizi içeren 'sessioninfo::session_info()' çıktısı dahil edilecektir.
...
5) *eğer* *asıl* isteği karşılayan bir yanıt alırsanız, soruyu yanıtlandı olarak işaretlemeyi unutmayın. Bu durum, başkalarının çözümü daha sonra hızlı bulmasına yardımcı olur.
...
Nasıl [yardım alacağınız](https://www.tidyverse.org/help/#:~:text=When%20you%20want%20to%20make,to%20load%20the%20reprex%20package.&text=Enter%20reprex()%20in%20the,preview%20of%20your%20rendered%20reprex.) hakkında Tidyverse sayfası!

[Minimum bir veri kümesi üretmeye](https://xiangxing98.github.io/R_Learning/R_Reproducible.nb.html#producing-a-minimal-dataset) ilişkin ipuçları
