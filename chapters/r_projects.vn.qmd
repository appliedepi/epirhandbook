...
Dưới đây là một vài ví dụ về cách nhập/xuất/lưu trữ sử dụng lệnh `here()` bên trong một dự án R. Đọc thêm về package **here** trong chương [Nhập xuất dữ liệu](importing.vn.qmd).  
