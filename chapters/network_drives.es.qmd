---
aliases:
  - /new_pages/network_drives.es.html
---

# R en redes locales {#network-drives}
...
* Comprueba la instalación de TinyTex, o instala TinyTex en la ubicación C:. Consulta la página de [fundamentos de R](basics.es.qmd) sobre cómo instalar TinyTex. 
...
* La solución anterior funcionó al ejecutar knit en una unidad local, pero con una conexión a Internet en red
