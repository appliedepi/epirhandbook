...
* Se ha creado un archivo *gitignore* en caso de que se vincule este proyecto R a un repositorio de Github (ver [Control de versiones y colaboración con Github](#version-control-and-collaboration-with-git-and-github))
...
Te recomendamos utilizar la carpeta "scripts" para almacenar "archivos de ejecución" o scripts .R que tus scripts .Rmd cargan con `source()`. Consultá la página sobre [R Markdown](#reports-with-r-markdown) para obtener consejos sobre cómo estructurar tu código en varios archivos. 
