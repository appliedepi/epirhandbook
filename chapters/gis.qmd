...
The handbook shows a saved copy of this basemap, fetched once with the code above on 2 September 2026, so that the page builds without an internet connection. Map data © OpenStreetMap contributors.  
