...
* El paquete **appliedepidata** contiene todos los datos de ejemplo de este manual. Consulta [Descargar el manual y los datos](data_used.qmd) para la versión sin conexión del manual.
