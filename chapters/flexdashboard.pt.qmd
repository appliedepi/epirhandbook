...
* `{data-orientation=}` Defina para `rows` ou `columns`. Se o seu painel tiver várias páginas, adicione este atributo a cada página para indicar a orientação (mais explicado em [seção de layout](#layout)).  
