...
Vous pouvez également insérer du code R en ligne dans du texte, comme décrit à la page [Rapports avec R Markdown](#rmarkdown), en entourant le code de crochets arrière et en commençant la commande par "r" : `` `r 1+1` `` (voir l'exemple avec la date ci-dessus).  
