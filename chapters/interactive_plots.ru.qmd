...
Практически любой график `ggplot()` можно сделать интерактивным, в том числе и тепловые графики. На странице [Тепловые графики](heatmaps.ru.qmd) вы можете прочитать о том, как сделать приведенный ниже график, который отображает долю дней в неделю, когда определенные учреждения предоставляли данные в свою провинцию.  
