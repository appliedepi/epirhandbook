---
aliases:
  - /new_pages/network_drives.fr.html
---

# R sur les lecteurs réseau {#network-drives}
...
* Vérifiez l'installation de TinyTex, ou installez TinyTex à l'emplacement C :. Voir la page [R - les bases](basics.fr.qmd)pour savoir comment installer TinyTex.  
...
L'erreur ressemblera à quelque chose comme ceci : `can't find file...rmarkdown...lua...`. Cela signifie qu'il n'a pas pu trouver ce fichier.  
...
Une erreur du type : `! Package pdftex.def Error: File 'cict_qm2_2020-06-29_files/figure-latex/unnamed-chunk-5-1.png' not found: using draft setting.` ou `Error: LaTeX failed to compile file_name.tex.`.  
