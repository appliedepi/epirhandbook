...
Par exemple : `Error: pandoc document conversion failed with error 61` ou `Impossible d'aller chercher...`.  
...
Une erreur du type : `! Package pdftex.def Error: File 'cict_qm2_2020-06-29_files/figure-latex/unnamed-chunk-5-1.png' not found: using draft setting.` ou `Erreur : LaTeX n'a pas réussi à compiler file_name.tex.`.  
