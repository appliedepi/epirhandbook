...
For the examples in this page, we import the cleaned linelist of cases from a simulated Ebola epidemic. Tải trực tiếp bằng `appliedepidata::get_data(name = "linelist_cleaned_rds")` (xem trang [Tải sách và dữ liệu](data_used.vn.qmd) để biết chi tiết).    
