...
- Cria nova coluna `num_NA_dates`, definida para cada linha como o número de colunas (com nome contendo "date") para as quais `is.na()` avaliadas para VERDADEIRO (estão faltando dados).\
