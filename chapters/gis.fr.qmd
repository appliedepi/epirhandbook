...
**Tout d'abord**, créez un tampon circulaire d'un rayon de ~2,5 km autour de chaque établissement de santé. Ceci est fait avec la fonction `st_buffer()` de **sf**. Parce que l'unité de la carte est en degrés décimaux lat/long, c'est ainsi que "0,02" est interprété. Si le système de coordonnées de votre carte est en mètres, le nombre doit être fourni en mètres.  
