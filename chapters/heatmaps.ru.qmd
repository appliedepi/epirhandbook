...
Мы начнем с построчного списка случаев моделирования эпидемии лихорадки Эбола. Загрузите их напрямую с помощью `appliedepidata::get_data(name = "linelist_cleaned_rds")` (подробности см. на странице [Скачивание руководства и данных](data_used.ru.qmd)).  
...
В настоящее время учреждения расположены в алфавитно-цифровом порядке снизу вверх. Если вы хотите изменить порядок учреждений по оси y, преобразуйте их в класс фактор и укажите порядок. Советы см. на странице [Факторы].  
