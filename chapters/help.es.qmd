...
Lee más sobre cómo almacenar tu trabajo en Github en la página [Colaboración y Github](collaboration.es.qmd).
...
* Puedes leer más sobre los argumentos y las posibles variaciones en la [documentación](https://reprex.tidyverse.org/reference/reprex.html) o introduciendo ?reprex
