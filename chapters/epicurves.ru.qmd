...
На этой странице мы демонстрируем построение эпидемических кривых с помощью пакета **ggplot2**, который открывает широкие возможности настройки.
...
Пакет **incidence2** предлагает альтернативный подход с более простыми командами, но на момент написания он дорабатывался и не был стабильным. Он будет снова добавлен в эту главу, когда станет стабильным.  
...
Необходимо *вручную* управлять агрегированием случаев по времени (по неделям, месяцам и т.д.) *и *интервалами меток на оси дат. Это требует тщательного контроля.  
