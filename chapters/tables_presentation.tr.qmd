...
Aşağıda, [Tanımlayıcı tablolar] sayfasından, vaka `linelist`'i örnek olarak kullanılmıştır. Hazırlanan tabloda toplamlar satırı ile hastaneye göre hasta sonuçları ve CT değerlerini özetlenmiştir. Çıktı `table` olarak kaydedilmiştir.  
