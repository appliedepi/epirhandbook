...
Tablo nesnesi bir R Markdown kod parçasında çağrılırsa, tablo otomatik bir belgeye, yani R Markdown çıktısına entegre edilebilir. Bu, değişen verilerle tablonun güncellenebileceği ve böylece sayıların yenilenebileceği anlamına gelmektedir.
