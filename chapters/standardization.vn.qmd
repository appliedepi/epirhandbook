...
Xem chương [Tải sách và dữ liệu](data_used.vn.qmd) để biết các hướng dẫn về cách tải tất cả các bộ số liệu mẫu trong cuốn số tay này. Bạn có thể nhập trực tiếp dữ liệu của chương Chuẩn hóa này vào R bằng các lệnh `appliedepidata::get_data()` sau:  
