...
<span style="color: black;">**_ПРИМЕЧАНИЕ:_** Структурированные данные по отслеживанию контактов из других программ (например, KoBo, DHIS2 Tracker, CommCare) могут выглядеть по-другому. Если вы хотите предложить альтернативные примеры данных или материалы для этой страницы, [свяжитесь с нами](../index.ru.qmd).</span> 

<span style="color: darkgreen;">**_СОВЕТ:_** Если вы используете данные Go.Data и хотите связать это с вашим API, см. страницу Импорта и экспорта [(раздел по API)](importing.ru.qmd#import_api) и [Сообщество практиков Go.Data](https://community-godata.who.int/).</span>
