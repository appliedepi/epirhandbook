...
Ниже есть ссылки на файлы для страницы [Информационные панели c R Markdown](flexdashboard.ru.qmd). Это исходные файлы R Markdown/HTML, а не примеры наборов данных, поэтому они не входят в пакет **appliedepidata** - скачайте их напрямую с Github:  
...
Страница [Отслеживание контактов](contact_tracing.ru.qmd) демонстрирует анализ данных по отслеживанию контактов, используя пример данных из [Go.Data](https://github.com/WorldHealthOrganization/godata/tree/master/analytics/r-reporting). Эти данные не входят в **appliedepidata**; данные, используемые на этой странице, могут быть скачены как файлы .rds, кликнув на следующие ссылки:  
...
<span style="color: black;">**_ПРИМЕЧАНИЕ:_** Структурированные данные по отслеживанию контактов из других программ (например, KoBo, DHIS2 Tracker, CommCare) могут выглядеть по-другому. Если вы хотите предложить альтернативные примеры данных или материалы для этой страницы, [свяжитесь с нами](#contact_us).</span> 
