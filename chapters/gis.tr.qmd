...
Sierra Leone için tüm idari sınırları önceden İnsani Veri Değişimi'nden (HDX) [web sitesi burada](https://data.humdata.org/dataset/sierra-leone-all-ad-min-level-boundaries) indirdik. Alternatif olarak, bu el kitabı için bunları ve diğer tüm örnek verileri [El kitabını ve verileri indir](data_used.tr.qmd) sayfasında açıklandığı gibi R paketimiz aracılığıyla indirebilirsiniz.
...
Yine sağlık tesislerinin konumlarını HDX [buradan](https://data.humdata.org/dataset/hotosm_sierra_leone_health_facilities) veya [el kitabını ve verileri indir](data_used.tr.qmd) sayfasındaki talimatlar aracılığıyla indirdik.
