...
Você pode tornar quase qualquer gráfico do `ggplot()` interativo, incluindo o gráfico de calor. Na página [Gráficos de calor](#heatmaps), você pode ler como criar o gráfico a seguir, que mostra a proporção de dias por semana que certas instalações reportaram dados de malária  à sua província.
