...
La fonction de **base** R cat()` peut être enroulée autour de la commande ci-dessus afin d'imprimer le résultat dans la console R, en affichant les nouvelles lignes ajoutées.
