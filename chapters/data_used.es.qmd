...
La página de [rastreo de contactos](#contact-tracing-1) muestra el análisis de los datos de rastreo de contactos, utilizando como ejemplo datos de [Go.Data](https://github.com/WorldHealthOrganization/godata/tree/master/analytics/r-reporting). Estos datos no forman parte de **appliedepidata**; los datos utilizados en la página pueden descargarse como archivos .rds clicando en los siguientes enlaces:
