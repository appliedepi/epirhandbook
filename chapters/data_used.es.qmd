...
* Instala nuestro paquete R **appliedepidata** que contiene todos los datos del ejemplo (el proceso de instalación se describe a continuación)
...
# importar defunciones del país A
...
# importar defunciones del país B
...
Puedes [clicar aquí para descargar el archivo plot_epicurve.R](https://github.com/appliedepi/epirhandbook/raw/main/data/malaria_app/funcs/plot_epicurve.R) que es originado por global.R. Ten en cuenta que puede necesitar almacenarlo dentro de una carpeta "funcs" para que las rutas de los archivos here() funcionen correctamente.
