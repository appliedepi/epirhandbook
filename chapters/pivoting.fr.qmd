...
Ci-dessus, notre restructuration a fusionné *dates* et *caractères* en une seule colonne `valeur`. Face à deux colonnes de classes différentes, la fonction convertit par défaut la colonne entière en chaîne de caractères, et l'utilité des dates est perdue.  
