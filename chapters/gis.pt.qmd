...
Para carregar o shapefile usamos `get_data()` do **appliedepidata**, que o retorna como um objeto **sf**. Para ler seu próprio shapefile use `read_sf()` do **sf** com o caminho do arquivo (veja as páginas [Importar e exportar](importing.pt.qmd) e [Projetos R](r_projects.pt.qmd)).
...
Nós carregamos os pontos das unidades com `get_data()`. Novamente limpamos os nomes das colunas e depois filtramos para manter apenas os pontos marcados com "hospital", clínica ("clinic"), ou doutores ("doctors").  
