...
Novamente, baixamos os locais das unidades de saúde do HDX [aqui](https://data.humdata.org/dataset/hotosm_sierra_leone_health_facilities) ou por meio das instruções na página [manual de Download e dados](data_used.pt.qmd).   
