...
**Primeiro**, crie uma área de influência circular com um raio de ~2.5km ao redor de cada unidade de saúde. Isso é feito com a função `st_buffer()` do pacote **sf**. Pelo fato das unidades do mapa estarem em lat/long em graus decimais, é assim que "0.02" será interpretado. Se o sistema de coordenadas do seu mapa for em metros, o número deve ser fornecido em metros.  
