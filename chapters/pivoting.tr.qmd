...
name_from argümanı, yeni sütun adlarının oluşturulacağı *names* sütunu belirtirken; `values_from` argümanı, hücreleri doldurmak için gereken değerlerin alınacağı sütunu belirtir. `id_cols =` argümanı isteğe bağlıdır, ancak pivotlanmaması gereken sütun adlarından oluşan bir vektör verilebilir; bu sütunlar böylece her satırı tanımlar.  
