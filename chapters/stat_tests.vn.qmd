...
USử dụng cú pháp công thức để chỉ định cột biến liên tục và cột biến phân loại:  
...
Mối tương quan giữa các biến định lượng có thể được kiển bằng cách sử dụng package **corrr** thuộc **tidyverse**. Package này cho phép tính các hệ số tương quan bằng phương pháp Pearson, Kendall hoặc Spearman. Gói lệnh này tạo ra một bảng kết quả và cũng có chức năng tự động vẽ các giá trị. 
