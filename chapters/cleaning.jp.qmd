...
以下は、発症日のヒストグラムを作成するためのシンプルなコマンドです。この未加工データセットには、2012～2013 年に発生した 2 つ目の小規模なアウトブレイクも含まれていることがわかります。今回の分析では、この以前のアウトブレイクをラインリストから削除していきます。
