---
aliases:
  - /new_pages/help.pt.html
---

# Conseguindo ajuda  {#help}

Esta página aborda sobre como obter ajuda postando um problema (issue) no Github ou postando um exemplo reprodutível ("reprex") em um fórum online.
...
Leia mais sobre como armazenar seu trabalho no Github na página [Colaboração e Github](collaboration.pt.qmd). 
...
* Se você definir `session_info = TRUE`, será incluída a saída de `sessioninfo::session_info()`, com suas versões do R e dos pacotes R
...
* Dê um exemplo reprodutível mínimo com as informações da sua sessão do R
