...
Tek basamaklı sayıları çift basamaklı sayılara dönüştürmek için (ör. 2 basamak elde etmek için baştaki sıfırlarla birlikte saat veya dakika formatına), [Karakterler ve dizeler sayfasının "Taban uzunluğu" bölümüne](characters_strings.tr.qmd#str_pad) bakınız.
...
`case_when()` hakkında daha fazla bilgi edinmek için [Temizleme verileri ve temel işlevler](cleaning.tr.qmd) hakkındaki sayfaya bakınız.
