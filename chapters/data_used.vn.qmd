...
Dưới đây là các liên kết đến tệp được dùng trong chương [Dashboards với R Markdown](flexdashboard.vn.qmd). Đây là các tệp nguồn R Markdown/HTML, không phải bộ dữ liệu minh họa, nên chúng không thuộc package **appliedepidata** - hãy tải chúng trực tiếp từ Github:
