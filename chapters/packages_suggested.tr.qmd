...
* **appliedepidata** paketi bu el kitabı için tüm örnek verileri içermektedir. El kitabının çevrimdışı sürümü için [El kitabını ve verileri indir](data_used.tr.qmd) sayfasına bakın.
