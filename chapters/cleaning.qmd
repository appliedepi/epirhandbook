...
If you want to follow along, use `appliedepidata::get_data(name = "case_linelists_linelist_raw")` to load the "raw" linelist directly in R (see the [Download handbook and data](data_used.qmd) page).
