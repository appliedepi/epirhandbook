...
Importamos o conjunto de dados dos casos de uma epidemia simulada de Ébola. Carregue diretamente com `appliedepidata::get_data(name = "linelist_cleaned_excel")` (consulte a página [Baixar manual e dados](data_used.pt.qmd) para mais detalhes). Em seguida, utilizamos `data.table()` para converter o quadro de dados em um data table.
