---
aliases:
  - /new_pages/phylogenetic_trees.tr.html
---
...
Ayrıca tüm örneklerin ağaç dosyasında bulunup bulunmadığını ve bunun tersini, eşleşip eşleşmedikleri bir DOĞRU veya YANLIŞ mantıksal vektörü oluşturarak karşılaştırabiliriz. (Basitleştirmek için burada gösterilmemiştir).
...
2017 ve 2018'de alt ağacımızda 39. nodda meydana gelen klonal genişlemeli vaka kümesini araştırdığımızı varsayalım. Yakın ilişkili diğer suşların kökenini görmek için suş izolasyon yılının yanı sıra ülkeye göre seyahat geçmişi ve rengi de ekliyoruz:
