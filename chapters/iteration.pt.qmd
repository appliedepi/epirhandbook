...
A sintaxe básica é: `for (item em sequência) {fazer operações usando item}`. Observe os parênteses e as chaves. Os resultados podem ser impressos no console ou armazenados em um objeto R (o container).
