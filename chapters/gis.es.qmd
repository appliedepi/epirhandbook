...
Una vez más, hemos descargado la localización de los centros sanitarios desde el HDX [aquí](https://data.humdata.org/dataset/hotosm_sierra_leone_health_facilities) o mediante las instrucciones de la página [descarga de manuales y datos](data_used.es.qmd).
