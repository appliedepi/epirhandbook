...
See the page on importing page section on [Missing data](importing.qmd#import_missing) for details, as the exact syntax varies by file type.  
...
You can list columns one after the other, or use ["tidyselect" helper functions](cleaning.qmd#clean_tidyselect):  
