---
aliases:
  - /new_pages/moving_average.fr.html
---
...
Si vous avez des séries temporelles propres avec des valeurs pour chaque date, vous pouvez utiliser `slide_dbl()`, comme démontré ici dans la page [Série chronologique et détection des épidémies](time_series.fr.qmd).  
...
Voir la page du manuel sur le [Regroupement des données](grouping.fr.qmd) pour plus de détails sur le regroupement des données.
