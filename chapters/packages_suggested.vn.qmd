...
* Package **appliedepidata** chứa tất cả các dữ liệu minh họa cho sổ tay này. Xem [Tải xuống sổ tay và dữ liệu](data_used.vn.qmd) để biết phiên bản ngoại tuyến của sổ tay.  
