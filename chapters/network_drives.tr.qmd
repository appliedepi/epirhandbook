---
aliases:
  - /new_pages/network_drives.tr.html
---

# Ağ sürücülerinde R {#network-drives}
...
* TinyTex kurulumunu kontrol edin veya TinyTex'i C: konumuna kurun. TinyTex'in nasıl kurulacağını öğrenmek için [R temelleri](basics.tr.qmd) sayfasına bakabilirsiniz.
...
Örneğin, `Error in tools::startDynamicHelp() : internet routines cannot be loaded`
...
* RStudio'yu her zaman yönetici olarak çalışacak şekilde ayarlamak için (açmak üzere RStudio simgesine tıklamadığınız bir Rproject kullanırken avantajlıdır) Rstudio simgesine sağ tıklayın
