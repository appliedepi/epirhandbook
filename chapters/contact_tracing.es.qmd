...
Aquí están las primeras 50 filas del conjunto de datos `followups`, de `nrow(followups)` filas (cada fila es una interacción de seguimiento, con el estado del resultado en la columna `followup_status`):
