...
**Đầu tiên**, tạo một vùng đệm hình tròn với bán kính \~2.5km xung quanh mỗi cơ sở y tế. Điều này được thực hiện với hàm `st_buffer()` trong package **sf**. Bởi vì đơn vị của bản đồ là kinh/vĩ độ thập phân, đó là cách "0.02" được diễn giải. Nếu hệ tọa độ bản đồ của bạn tính bằng mét, thì số đó phải được cung cấp bằng mét.
