...
Với tệp .rds, `import()` sẽ cảnh báo trừ khi bạn truyền `trust = TRUE`, nghĩa là bạn tin tưởng nguồn gốc của tệp. Chỉ dùng nó với các tệp do chính bạn tạo ra hoặc lấy từ một nguồn đáng tin cậy.  
