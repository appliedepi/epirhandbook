...
Um exemplo de um caminho de arquivo relativo construído com `here()` está abaixo. Supomos que o trabalho esteja em um projeto R que contém uma subpasta "dados" e dentro dela uma subpasta "linelists", na qual há o arquivo .xlsx de interesse (crie-o com `appliedepidata::save_data()`, como mostrado acima).    
...
```{r, eval=F}
appliedepidata::save_data(name = "linelist_cleaned", path = here("dados", "linelists"))
