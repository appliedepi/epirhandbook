...
Để bắt đầu, chúng ta nhập bộ dữ liệu có tên linelist đã làm sạch bao gồm các trường hợp từ vụ dịch Ebola mô phỏng. Tải trực tiếp bằng `appliedepidata::get_data(name = "linelist_cleaned_rds")` (xem trang [Tải sách và dữ liệu](data_used.vn.qmd) để biết chi tiết).
...
Xem mục [thang đo cho màu sắc trong chương Các mẹo với ggplot](ggplot_tips.vn.qmd#ggplot_tips_colors).
...
Bạn có thể hiển thị ba biến liên tục bằng cách sử dụng đối số `fill =` để tạo một *biểu đồ nhiệt*. Màu của mỗi “ô” sẽ phản ánh giá trị của biên liên tục thứ ba trong bộ dữ liệu. Xem chương [Các mẹo với ggplot](ggplot_tips.vn.qmd) và chương [Biều đồ nhiệt](heatmaps.vn.qmd) để biết thêm chi tiết và một số ví dụ.
