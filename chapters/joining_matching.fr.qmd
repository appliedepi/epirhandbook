...
Avant une jointure, il est souvent rassurant de convertir une colonne tout en minuscules ou majuscules. Pour cela, on peut utiliser `mutate()` et une de ces fonctions de **stringr** (voir le chapitre [sur les chaînes de caractères](#character_strings)):  
