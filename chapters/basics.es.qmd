...
* Especificar los dos colores a utilizar (`pal = ` es la abreviatura de "paleta" y se suministra con un vector de dos nombres de color. Para saber cómo se hace un vector con la función `c()` puedes consultar la página de [objetos](#objects) .
