...
```{r, message=FALSE, echo=F}
# exibir o shapefile como uma tabela
DT::datatable(head(infectors, 50), rownames = FALSE, options = list(pageLength = 50, scrollX = T), class = 'white-space: nowrap')
```
...
```{r, message=FALSE, echo=F}
# exibir o shapefile como uma tabela
DT::datatable(head(infector_ages, 50), rownames = FALSE, options = list(pageLength = 50, scrollX = T), class = 'white-space: nowrap')
```
...
```{r, message=FALSE, echo=F}
# exibir o shapefile como uma tabela
DT::datatable(head(ages_complete, 50), rownames = FALSE, options = list(pageLength = 50, scrollX = T), class = 'white-space: nowrap')
```
...
```{r, message=FALSE, echo=F}
# exibir o shapefile como uma tabela
DT::datatable(head(long_counts, 50), rownames = FALSE, options = list(pageLength = 50, scrollX = T), class = 'white-space: nowrap')
```
...
```{r, message=FALSE, echo=F}
# exibir o shapefile como uma tabela
DT::datatable(head(long_prop, 50), rownames = FALSE, options = list(pageLength = 50, scrollX = T), class = 'white-space: nowrap')
```
...
```{r, echo=F}
DT::datatable(head(facility_count_data, 30), rownames = FALSE, filter = "top", options = list (pageLength = 5, scrollX = T), class = 'white-space: nowrap')
```
