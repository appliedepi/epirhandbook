...
You can also insert in-line R code into text as described in the [Reports with R Markdown](rmarkdown.qmd) page, by surrounding the code with backticks and starting the command with "r": `` ` 1+1` ``(see example with date above).  
