...
-   Specify the two colors to use (`pal =` is short for "palette" and is supplied with a vector of two color names. See the [objects](basics.qmd#objects) page for how the function `c()` makes a vector)
