...
* Você pode usar `bind_rows()` em uma `list` de dataframes que tenham estrutura semelhante para combiná-los em um só. Veja um exemplo na página [Iteração, loops e listas](#iteration) que envolve a importação de múltimplas linelists com **purrr**.  
