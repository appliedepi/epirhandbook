...
-   **R Markdown**: é uma variação de markdown que *é específica de R* - permite escrever um documento usando markdown para produzir texto, *mas também incluir código em R e expor seus resultados*.\
