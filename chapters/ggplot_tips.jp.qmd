...
ggplot で時間スケールを使用すると聞くと難しく感じるかもしれませんが、いくつかのキーになる関数を用いることでとても簡単に行うことができます。時間や日付を扱う際は、変数が正しくフォーマットされていることを確認してください。詳細は[日付の扱い](#working-with-dates-1)の章を、例については[流行曲線](#epidemic-curves)の章の ggplot のセクションを参照してください。
