...
**Objectif:** Servir de manuel de référence rapide du code R (en ligne et **[hors line](chapters/data_used.fr.qmd)**) avec des exemples centrés sur la tâche qui traitent des problèmes épidémiologiques courants.  
...
* Soumettre des problèmes à notre **[dépôt Github](https://github.com/appliedepi/epirhandbook)**  
...
* Vous pouvez suivre avec [les données d'exemple de le chapitre](chapters/data_used.fr.qmd).  

**Version hors ligne**  

Voir les instructions de la page [Télécharger le manuel et les données](chapters/data_used.fr.qmd).  
