...
**Задача:** Служит кратким справочником по R (онлайн и [**оффлайн**](data_used.qmd)) с примерами, ориентированными на задачи, которые направлены на часто встречающиеся проблемы в эпидемиологии.  
