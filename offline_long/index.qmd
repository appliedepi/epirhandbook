...
<br> [**Written by epidemiologists, for epidemiologists**]{style="color: black;"}
...
-   Submit issues to our [**Github repository**](https://github.com/appliedepi/epirhandbook)
...
<input type="hidden" name="hosted_button_id" value="YTEZELC8VBXV6" /> <input type="image" src="https://github.com/appliedepi/epirhandbook/raw/main/images/donate_button_long.png" border="0" name="submit" title="PayPal - The safer, easier way to pay online!" alt="Donate with PayPal button" /> <img src="https://www.paypal.com/en_US/i/scr/pixel.gif" border="0"/>
...
-   You can follow-along with [the example data](#data-used)

**Offline version**

See instructions in the [Download handbook and data](#data-used) page.
