...
**目的:** 疫学業務や研究で頻繁に直面する課題に対する対処法の実例を扱い、素早く使用できる R のリファレンスマニュアルとしてオンラインでも**[オフライン](chapters/data_used.jp.qmd)**でも機能する  
...
* 例題で使用されている [サンプルデータ](chapters/data_used.jp.qmd) を使用すると、本書の内容をお手元の環境で実践しながら学ぶことができます。  

**オフライン版の使い方**  

[ハンドブックとデータのダウンロード](chapters/data_used.jp.qmd) の章をご覧ください。  
