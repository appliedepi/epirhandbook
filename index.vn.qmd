...
**Mục tiêu:** Là một tài liệu tham khảo R một cách nhanh chóng (trực tuyến và **[ngoại tuyến](chapters/data_used.vn.qmd)**), cung cấp các ví dụ tập trung vào nhiệm vụ giải quyết các vấn đề dịch tễ học phổ biến.  
...
-   Kết hợp theo dõi cùng với các bộ [dữ liệu minh họa](chapters/data_used.vn.qmd)\
-   Xem phần "Tài nguyên" trong từng chương để tìm thêm tài liệu

**Phiên bản ngoại tuyến**

Xem hướng dẫn tại trang [Tải sách và dữ liệu](chapters/data_used.vn.qmd).
