...
**Objective:** Serve as a quick R code reference manual (online and [**offline**](chapters/data_used.qmd)) with task-centered examples that address common epidemiological problems.
...
-   You can follow-along with [the example data](chapters/data_used.qmd)

**Offline version**

See instructions in the [Download handbook and data](chapters/data_used.qmd) page.
