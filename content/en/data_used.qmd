...
* The search box does not work offline. Use Ctrl+f (Cmd+f on a Mac) to search the page you are reading.
* See the [Suggested packages](packages_suggested.qmd) page to install the R packages you need before you lose your connection.

**To download the handbook:**

<a href='https://github.com/appliedepi/epirhandbook/releases/download/offline/epirhandbook-en.zip' class='download-button'>Download the handbook (zip)</a>
...
<span style="color: black;">**_NOTE:_** Structured contact tracing data from other software (e.g. KoBo, DHIS2 Tracker, CommCare) may look different. If you would like to contribute alternative sample data or content for this page, please [contact us](index.qmd).</span>

<span style="color: darkgreen;">**_TIP:_** If you are deploying Go.Data and want to connect to your instance's API, see the Import and export page [(API section)](importing.qmd#import_api) and the [Go.Data Community of Practice](https://community-godata.who.int/).</span>
...
The [GIS basics](gis.qmd) page loads all three data sets: the admin-3 boundaries `sle_adm3`, the health facility points `sle_hf`, and the population table `sle_admpop_adm3_2020`. To read a shapefile from your own file path, use `read_sf()` from the **sf** package. The [GIS basics](gis.qmd) page also links to the *Humanitarian Data Exchange* website, where you can download further shapefiles as zipped files. The health facility points, for example, are [here](https://data.humdata.org/dataset/hotosm_sierra_leone_health_facilities).
