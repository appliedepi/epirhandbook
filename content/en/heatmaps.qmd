...
We begin from the case linelist of a simulated Ebola epidemic. Load it directly with `appliedepidata::get_data(name = "linelist_cleaned_rds")` (see the [Download handbook and data](data_used.qmd) page for details).
