---
aliases:
  - /new_pages/survey_analysis.html
---
...
We can use the `find_start_date()` and `find_end_date()` functions from **sitrep** to fine the causes for 
...
There are three options using functions from the following packages: 
**survey**, **srvyr** and **gtsummary**. 
The **survey** code is likely to be the most stable long-term, whereas 
