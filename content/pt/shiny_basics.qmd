...
Para um método alternativo de fazer painéis, que é mais rápido e mais fácil, mas talvez menos personalizável, consulte a página **flextable** ([Painéis com R Markdown](flexdashboard.qmd)).  
...
Neste manual, enfatizamos `p_load()` de **pacman**, que instala o pacote se necessário *e* o carrega para uso. Você também pode carregar pacotes instalados com `library()` do R **base**. Veja a página em [Introdução ao R](basics.qmd) para mais informações sobre pacotes R.  
...
Se você gostaria de acompanhar esta página, consulte esta seção do [Baixar manual e dados](data_used.qmd). Existem links para baixar os scripts R e arquivos de dados que produzem o aplicativo Shiny final.  
