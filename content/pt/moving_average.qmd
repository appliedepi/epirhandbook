...
Se você possuir dados com séries cronológicas limpas, com valores para cada data, você pode estar OK para utilizar a função `slide_dbl()`, como demonstrado aqui na página sobre [Séries temporais e detecção de surtos](time_series.qmd#timeseries_moving).
...
Veja a página sobre [Agrupamento dos dados](grouping.qmd), deste manual, para detalhes sobre agrupamento dos dados.
