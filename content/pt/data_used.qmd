...
* Abra `index.html` na pasta descompactada para começar a ler.
* A caixa de busca não funciona offline. Use Ctrl+f (Cmd+f em um Mac) para buscar na página que você está lendo.
* Veja a página [Pacotes sugeridos](packages_suggested.qmd) para instalar os pacotes R de que você precisa antes de perder a conexão.

**Para baixar o livro:**

<a href='https://github.com/appliedepi/epirhandbook/releases/download/offline/epirhandbook-pt.zip' class='download-button'>Baixar o livro (zip)</a>
