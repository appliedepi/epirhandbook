...
Se você não conseguir encontrar uma resposta para o seu problema, mesmo depois de pesquisar muito, considere criar um *exemplo reprodutível* ("reprex") e postar a pergunta você mesmo. Consulte a página [Obtendo ajuda](help.qmd) para dicas sobre como criar e postar um exemplo reprodutível em fóruns.
