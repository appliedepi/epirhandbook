...
Utilizaa **gtsummary** si quieres añadir los resultados de una prueba estadística a una tabla estéticamente presentada, creada con este paquete (como se describe en la sección **gtsummary** del capítulo [Tablas descriptivas](tables_descriptive.qmd#tbl_gt)).
