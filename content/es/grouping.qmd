...
Véase la sección **dplyr** de la página [Tablas descriptivas](tables_descriptive.qmd) para una descripción detallada de cómo producir tablas de resumen con `summarise()`. Aquí abordamos brevemente cómo cambia su comportamiento cuando se aplica a datos agrupados. 
...
Consulta la página de [De-duplicación](deduplication.qmd) para ver más ejemplos y detalles sobre `slice()`. 
