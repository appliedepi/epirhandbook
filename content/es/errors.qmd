...
Si después de mucho buscar no encuentras una respuesta a tu problema, considera la posibilidad de crear un ejemplo *reproducible* ("reprex") y publicar tú mismo la pregunta. Consulta la página sobre [Cómo obtener ayuda](help.qmd) para obtener consejos sobre cómo crear y publicar un ejemplo reproducible en los foros.
