...
Si tienes datos de series temporales limpios con valores para cada fecha, puede estar bien utilizar `slide_dbl()`, como se demuestra aquí en la página de [series temporales y detección de brotes](time_series.qmd#timeseries_moving).
...
Consulta la página del manual sobre [Agrupar datos](grouping.qmd) para obtener detalles sobre la agrupación de datos.
