...
* El buscador no funciona sin conexión. Usa Ctrl+f (Cmd+f en un Mac) para buscar en la página que estás leyendo.
* Consulta la página [Paquetes recomendados](packages_suggested.qmd) para instalar los paquetes de R que necesitas antes de perder la conexión.

**Para descargar el manual:**

<a href='https://github.com/appliedepi/epirhandbook/releases/download/offline/epirhandbook-es.zip' class='download-button'>Descargar el manual (zip)</a>
