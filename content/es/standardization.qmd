...
Consulta la página de [descargando el manual y los datos](data_used.qmd) para obtener instrucciones sobre cómo descargar todos los datos de ejemplo del manual. Puedes cargar los datos de la página de estandarización directamente en R con las siguientes llamadas a `appliedepidata::get_data()`:
...
En primer lugar, combinamos los datos de las poblaciones de los países, los pivotamos "largo" y realizamos una pequeña limpieza. Para más detalles, consulta la página sobre [pivotar datos](pivoting.qmd).
