...
Если после тщательных поисков вы не можете найти ответ на свою проблему, попробуйте создать *воспроизводимых пример* ("reprex") и разместить вопрос сами. См. страницу [Получение помощи](help.qmd) с советами о том, как создавать и размещать воспроизводимый пример на форумах. 
