...
* Поле поиска не работает офлайн. Используйте Ctrl+f (Cmd+f на Mac), чтобы искать на открытой странице.
* Смотрите страницу [Рекомендованные пакеты](packages_suggested.qmd), чтобы установить нужные пакеты R до потери связи.

**Чтобы скачать справочник:**

<a href='https://github.com/appliedepi/epirhandbook/releases/download/offline/epirhandbook-ru.zip' class='download-button'>Скачать справочник (zip)</a>
