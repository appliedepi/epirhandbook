---
aliases:
  - /new_pages/contact_tracing.ru.html
---
...
Вы можете скачать все примеры данных для этого руководства на странице [Скачивание руководства и данных](data_used.qmd). 
...
Как показано на странице, рассматривающей [Демографические пирамиды](age_pyramid.qmd), вы можете визуализировать возрастное и половое распределение (здесь мы используем пакет **apyramid**).  
