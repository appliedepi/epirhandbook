...
Bu kod parçası, analizler için gerekli olan paketlerin yüklenmesini gösterir. Bu el kitabında, gerekirse paketi kuran *ve* kullanım için yükleyen **pacman**'dan `p_load()` vurgusu yapıyoruz. R **tabanı**ndan `library()` ile kurulu paketleri de yükleyebilirsiniz. R paketleri hakkında daha fazla bilgi için [R basics](basics.qmd) sayfasına bakabilirsiniz.
...
**stringr**'den `unite()` fonksiyonu hakkında daha fazla bilgi edinmek için [Karakterler ve dizeler](characters_strings.qmd) hakkındaki sayfaya bakabilirsiniz.
