...
Bu paketle oluşturulmuş güzel bir tabloya istatistiksel bir testin sonuçlarını eklemek istiyorsanız **gtsummary** kullanın ([Açıklayıcı tablolar](tables_descriptive.qmd#tbl_gt) sayfasının **gtsummary** bölümünde açıklandığı gibi) ).
