---
aliases:
  - /new_pages/collaboration.tr.html
---
...
Git, bir klasördeki değişiklikleri izlemeye izin veren bir **sürüm kontrol** yazılımıdır. Word, LibreOffice veya Google belgelerindeki "değişikliği izle" seçeneği gibi, ancak her türden dosya için kullanılabilir. Sürüm kontrolü için en güçlü ve en çok kullanılan seçeneklerden biridir.
...
[Github Desktop](https://desktop.github.com/) yer alır; bu bölümde bu ikisini göstereceğiz.
...
git add content/en/collaboration.qmd  # commit edilecek dosyaları seçin (= değişiklikleri yapın)
...
**Not:** Commit edilen ancak gönderilmeyen (yani hala yerel olan) değişiklikleri geri almak, uzak depoya gönderilen (ve belki de zaten başka biri tarafından çekilmiş) değişiklikleri geri almaktan çok daha kolaydır, bu nedenle üzerinde çalıştığınız görevde değişiklik yapmayı bitirdiğinizde göndermek daha iyidir.

#### Rstudio'da {.unnumbered}

*PULL* - İlk olarak, aynı anda hem getirme (fetch) hem de çekme (pull) işlemini yapan "Çek" simgesine (aşağı ok) tıklayın.
...
***İPUCU:*** Parolanızı çok sık mı istedi? Bir SSH anahtarı kullanarak bir havuza bağlanmak için (daha karmaşıktır) bu [eğiticinin (https://happygitwithr.com/credential-caching.html#credential-caching) 10. ve 11. bölümlerine bakın.
