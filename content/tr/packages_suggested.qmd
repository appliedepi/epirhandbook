...
* Yüklenen birden çok paket aynı adda fonksiyonlara sahipse, en son yüklenen paketten gelen fonksiyonun önceliklendirildiği *masking*  ortaya çıkabilmektedir. [R temelleri](basics.qmd) sayfasında daha fazlasını bulabilirsiniz. Bu tür çakışmaları yönetmek için **conflicted** paketini kullanabilirsiniz.
* **pacman** ve maskeleme hakkında daha fazla bilgi için paketlerle ilgili [R temelleri](basics.qmd) bölümüne bakınız.

Bu el kitabının hazırlanması sırasında kullanılan R, RStudio ve R paketlerinin sürümlerini görmek için [Yazı ve teknik notlar](editorial_style.qmd) sayfasına bakınız.
...
* **appliedepidata** paketi bu el kitabı için tüm örnek verileri içermektedir. El kitabının çevrimdışı sürümü için [El kitabını ve verileri indir](data_used.qmd) sayfasına bakın.
