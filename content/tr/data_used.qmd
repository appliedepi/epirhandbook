...
* Arama kutusu çevrimdışı çalışmaz. Okuduğunuz sayfada arama yapmak için Ctrl+f (Mac'te Cmd+f) kullanın.
* Bağlantınızı kaybetmeden önce ihtiyacınız olan R paketlerini kurmak için [Önerilen paketler](packages_suggested.qmd) sayfasına bakın.

**El kitabını indirmek için:**

<a href='https://github.com/appliedepi/epirhandbook/releases/download/offline/epirhandbook-tr.zip' class='download-button'>El kitabını indir (zip)</a>
