---
aliases:
  - /new_pages/reportfactory.tr.html
---
...
Fabrika R projesinin içinden, normalde yaptığınız gibi bir R Markdown raporu oluşturun ve bunu "report_sources" klasörüne kaydedin. Talimatlar için [R Markdown](rmarkdown.qmd) sayfasına bakabilirsiniz. Örnek olması açısından, fabrikaya aşağıdakileri ekledik:
...
.Rmd komut dosyalarınız tarafından sağlanan "runfiles" veya .R komut dosyalarını depolamak için "scripts" klasörünü kullanmanızı öneririz. Kodunuzu birkaç dosyada nasıl yapılandıracağınıza ilişkin ipuçları için [R Markdown](rmarkdown.qmd) hakkındaki sayfaya bakabilirsiniz.
