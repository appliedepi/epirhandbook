...
Örnek için Ebola salgınını simüle vakaların veri setini içe aktaracağız. Doğrudan `appliedepidata::get_data(name = "linelist_cleaned_rds")` ile yükleyin (ayrıntılar için [El kitabı ve veri indirme](data_used.qmd) sayfasına bakın).
...
Lütfen [ggplot ipuçları sayfasının renk skalalarıyla ilgili bölüme](ggplot_tips.qmd#ggplot_tips_colors) bakın.
