...
* 展開したフォルダの `index.html` を開くと読み始められます。
* 検索ボックスはオフラインでは動作しません。開いているページ内を検索するには Ctrl+f（Mac では Cmd+f）を使ってください。
* 接続を失う前に必要な R パッケージを入れるには、[推奨するパッケージ](packages_suggested.qmd) のページをご覧ください。

**ハンドブックをダウンロードする:**

<a href='https://github.com/appliedepi/epirhandbook/releases/download/offline/epirhandbook-jp.zip' class='download-button'>ハンドブックをダウンロード (zip)</a>
