...
La matrice affiché ci-dessus montre les relations entre les régions de nos données `sle_adm3_dat`. Un score de 0 indique que deux régions ne sont pas voisines, tandis que toute valeur différente de 0 indique une relation de voisinage. Les valeurs de la matrice sont normalisées afin que chaque région ait un poids total  par ligne egale à 1.
