...
Voir la page [Télécharger le manuel et les données](data_used.qmd) pour savoir comment télécharger tous les exemples de données du manuel. Vous pouvez charger les données de la page de normalisation directement dans R avec les appels `appliedepidata::get_data()` suivants :  
...
Tout d'abord, nous combinons les ensembles de données sur les populations des pays, nous effectuons un pivot plus long et un nettoyage mineur. Voir la page [Pivoter les données](pivoting.qmd) pour plus de détails.  
