---
aliases:
  - /new_pages/network_drives.vn.html
---
...
2) Hãy lưu các packages trong thư viện trên một ổ đĩa được định danh bằng chữ cái (ví dụ: "C:"). Hạn chế tối đa Sử dụng package thư viện có đường dẫn bắt đầu bằng "\\\".  
...
* Kiểm tra cài đặt TinyTex hoặc cài đặt TinyTex vào ổ C:. Xem thêm chương [R cơ bản](basics.qmd) để biết về cách cài đặt TinyTex 
...
* Trong số nhiều vị trí thư viện đặt lưu trữ, hãy để vị trí có ổ đĩa được định danh bằng chữ cái được liệt kê đầu tiên (xem lại ở trên)
...
Có thể R không thể tìm thấy tệp của package **rmarkdown**, vì vậy hãy kiểm tra xem package **rmarkdown** đang được lưu trữ trong thư viện nào (xem đoạn code để thực hiện thao tác này ở trên). Nếu package được cài đặt vào một thư viện không thể truy cập được (ví dụ: bắt đầu bằng "\\\") hãy xem xét việc di chuyển nó sang C: hoặc thư viện ổ cứng theo cách thủ công. Lưu ý rằng package **rmarkdown** phải có thể kết nối với cài đặt TinyTex, vì vậy không thể tồn tại trong thư viện trên ổ đĩa mạng. 
