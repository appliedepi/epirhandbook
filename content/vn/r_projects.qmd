---
aliases:
  - /new_pages/r_projects.vn.html
---

# Dự án R {#r-projects}  


Một dự án R cho phép công việc của bạn được đóng gói trong một thư mục khép kín, dễ di chuyển. Trong dự án, tất cả các tập lệnh, tệp dữ liệu, biểu đồ/kết quả đầu ra và lịch sử có liên quan được lưu trữ trong các thư mục con và quan trọng là - *thư mục làm việc* là thư mục gốc của dự án.  
...
2) Package **here** dành cho các đường dẫn tương đối  
     - Đường dẫn tệp được ghi một cách tương đối dẫn đến thư mục gốc của dự án R - xem chương [Nhập xuất dữ liệu](importing.qmd) để biết thêm chi tiết  
...
* Nếu bạn muốn tạo một bản sao từ kho lưu trữ Github, hãy chọn tùy chọn thứ ba “Version Control” và sau đó chọn “Git”. Xem chương [Version control với Git và Github](collaboration.qmd) để biết thêm chi tiết.  
...
Dự án R bạn tạo ra sẽ có dạng một thư mục chứa tệp *.Rproj*. Tệp này là một lối tắt và nhiều khả năng là cách chính mà bạn sẽ mở dự án của mình. Bạn cũng có thể mở một dự án bằng cách chọn “Open Project” từ menu File. Ngoài ra, ở phía trên bên phải trên của RStudio, bạn sẽ thấy biểu tượng dự án R và menu thả xuống gồm các dự án R có sẵn. 
...
Thông thường sẽ có các thư mục con trong dự án của bạn. Hãy cân nhắc đặt tên các thư mục như “data”, “scripts”, “figures”, “presentations”. Bạn có thể thêm các thư mục theo cách thông thường mà bạn sẽ thêm một thư mục mới cho máy tính của mình. Ngoài ra, hãy xem chương [Tương tác với thư mục làm việc](directories.qmd) để tìm hiểu cách tạo thư mục mới bằng lệnh R.  
...
Một phương pháp phức tạp hơn đó là việc sử dụng Github hoặc một nền tảng tương tự để kiểm soát phiên bản. Xem chương [Version control với Git và Github](collaboration.qmd).  
...
Dưới đây là một vài ví dụ về cách nhập/xuất/lưu trữ sử dụng lệnh `here()` bên trong một dự án R. Đọc thêm về package **here** trong chương [Nhập xuất dữ liệu](importing.qmd).  
