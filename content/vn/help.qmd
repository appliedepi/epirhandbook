...
Tìm hiểu thêm về cách lưu trữ các tệp của bạn trên Github trong chương [Version control với Git và Github](collaboration.qmd).
...
Ấn vào mục Issues, bạn có thể thấy các vấn đề đang mở được hiện ra. Hãy xem lại chúng để đảm bảo những vấn đề này chưa được giải quyết. Bạn có thể mở một vấn đề mới bằng cách nhấp vào nút màu xanh lá cây ở bên phải. Để thực hiện những thao tác này, bạn sẽ cần mở một tài khoản Github. 
...
Trong vấn đề (issue) của bạn, hãy làm theo hướng dẫn bên dưới để cung cấp một ví dụ giả lập tối giản. Và hãy lịch sự! Phần lớn những người phát triển các package và dự án R đều làm việc đó trong thời gian rảnh của họ (giống như cuốn sổ tay này!).
...
* Đưa ra một ví dụ giả lập tối thiểu kèm theo thông tin về phiên làm việc R của bạn
