...
Chúng ta nhập bộ dữ liệu về các trường hợp từ một vụ dịch Ebola mô phỏng. Tải trực tiếp bằng `appliedepidata::get_data(name = "linelist_cleaned_excel")` (xem trang [Tải sách và dữ liệu](data_used.qmd) để biết chi tiết). Từ đây chúng tôi sử dụng `data.table()` để chuyển data frame thành data table.
