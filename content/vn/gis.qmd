...
Ma trận được in ở trên hiển thị mối quan hệ giữa 9 vùng trong dữ liệu `sle_adm3_dat` của chúng ta. Điểm 0 cho biết hai vùng không phải là láng giềng, trong khi bất kỳ giá trị nào khác 0 cho biết mối quan hệ láng giềng. Các giá trị trong ma trận được chia tỷ lệ để mỗi vùng có tổng trọng số hàng là 1.
