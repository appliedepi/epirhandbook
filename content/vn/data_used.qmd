...
* Mở `index.html` trong thư mục đã giải nén để bắt đầu đọc.
* Ô tìm kiếm không hoạt động khi ngoại tuyến. Hãy dùng Ctrl+f (Cmd+f trên máy Mac) để tìm trong trang bạn đang đọc.
* Xem trang [Package đề xuất](packages_suggested.qmd) để cài đặt các gói R bạn cần trước khi mất kết nối.

**Để tải sổ tay:**

<a href='https://github.com/appliedepi/epirhandbook/releases/download/offline/epirhandbook-vn.zip' class='download-button'>Tải sổ tay (zip)</a>
