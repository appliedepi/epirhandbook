---
aliases:
  - /new_pages/combination_analysis.vn.html
---
...
Trong biểu đồ minh họa bên trên, năm triệu chứng được trình bày. Bên dưới mỗi thanh dọc là một đường và dấu chấm biểu thị sự kết hợp của các triệu chứng được phản ánh bởi thanh ở trên. Ở bên phải, các thanh ngang phản ánh tần suất của từng triệu chứng riêng lẻ.  
...
Xem thêm chương [Ký tự và chuỗi](characters_strings.qmd) để biết thêm về hàm `unite()` trong package **stringr**
...
Nếu bạn muốn một lệnh hiệu quả hơn, bạn có thể tận dụng hàm `+()`, hàm này chuyển giá trị thành 1 và 0 dựa trên một mệnh đề logic. Lệnh này dùng kết hợp với hàm `across()` để thực hiện thay đổi trên nhiều cột cùng lúc (đọc thêm tại chương [Các hàm làm sạch dữ liệu](cleaning.qmd#clean_across)).  
