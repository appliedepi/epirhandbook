---
aliases:
  - /new_pages/transmission_chains.vn.html
---
...
Chúng ta nhập bộ dữ liệu về các trường hợp bệnh từ một vụ dịch Ebola mô phỏng. Nếu bạn muốn tải xuống dữ liệu để làm theo từng bước, hãy xem hướng dẫn trong chương [Tải sách và dữ liệu](data_used.qmd). Bộ dữ liệu được nhập bằng hàm `import()` từ package **rio**. Xem chương [Nhập xuất dữ liệu](importing.qmd) để biết các cách nhập dữ liệu khác nhau.
...
Ở đây, chúng ta thấy có một mối liên hệ có ý nghĩa thống kê giữa các liên kết lây nhiễm và giới tính.
...
Mười cá nhân nào có nhiều tiếp xúc nhất?

```{r}
head(sort(deg_both, decreasing = TRUE), 10)
```

Số lượng tiếp xúc trung bình là bao nhiêu?
