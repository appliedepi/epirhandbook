---
aliases:
  - /new_pages/interactive_plots.vn.html
---
...
Trong chương này chúng ta sẽ tập trung vào việc chuyển đổi một biểu đồ có sẵn được tạo bởi `ggplot()` thành một biểu đồ tương tác với **plotly**. Bạn có thể đọc thêm về **shiny** trong chương [Dashboards với Shiny](shiny_basics.qmd). Cũng cần nhấn mạnh là biểu đồ tương tác chỉ sử dụng được ở định dạng HTML trong tệp R markdown và không dùng được với tệp PDF hoặc Word.
...
Chúng ta bắt đầu bằng cách tạo một bộ dữ liệu tổng hợp cho từng tuần dịch tễ học, và phần trăm tử vong trong số các trường hợp đã biết outcome.  
...
Bạn có thể khiến hầu như bất kỳ loại biểu đồ nào tạo bởi `ggplot()` có khả năng tương tác, bao gồm biểu đồ nhiệt. Trong chương [Biểu đồ nhiệt](heatmaps.qmd), bạn có thể đọc thêm về cách tạo biểu đồ dưới đây để hiển thị tỷ lệ số ngày trong tuần mà các cơ sở y tế báo cáo dữ liệu lên tuyến tỉnh.  
