---
aliases:
  - /new_pages/moving_average.vn.html
---
...
Chúng ta nhập các trường hợp trong linelist đã được làm sạch từ một vụ dịch Ebola mô phỏng. Tải trực tiếp bằng `appliedepidata::get_data(name = "linelist_cleaned_rds")` (xem trang [Tải sách và dữ liệu](data_used.qmd) để biết chi tiết).
...
Nếu bạn có dữ liệu chuỗi thời gian đã được làm sạch với đủ giá trị cho tất cả các ngày, bạn có thể sử dụng hàm `slide_dbl()`, như đã được trình bày trong chương [Chuỗi thời gian và phát hiện ổ dịch](time_series.qmd).
...
### Biến động theo nhóm {#roll_slider_group .unnumbered}
...
Xem chương [Nhóm dữ liệu](grouping.qmd) trong sổ tay này để biết thêm chi tiết về nhóm dữ liệu.
