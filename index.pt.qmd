...
**Objetivo:** Servir como um guia de referência rápido para escrever código em R (online e [**offline**](chapters/data_used.pt.qmd)) com exemplos centrados em exercícios que abordam problemas epidemiológicos comuns.
...
-   Você pode seguir - junto com [os dados do exemplo](chapters/data_used.pt.qmd).\
-   Consulte a seção "Recursos" de cada página para obter mais material

**Versão off-line**

Veja as instruções na página [Fazer o Download do manual e dos dados](chapters/data_used.pt.qmd).
