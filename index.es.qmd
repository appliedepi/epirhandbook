...
**Objetivo:** Servir como breve guía de referencia para escribir código en R (en línea y [**versión sin conexión**](chapters/data_used.es.qmd)) con ejemplos detallados que aborden problemas epidemiológicos.  
...
Consulta las instrucciones en la página de [Descargar el Manual y los datos](chapters/data_used.es.qmd).
